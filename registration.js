function validation(){
    ...
    var user = document.getElementById('RIusername').value;
    ...
    var conPass = document.getElementById('CRIpassword').value;
    ...
    if(gender[0].checked != true && gender[1].checked != true && gender[2].checked != true){
        document.getElementById('checkGender').innerHTML = "** Please choose your gender<br>";
        return false;
    } 

   
    if(userType[0].checked != true && userType[1].checked != true && userType[2].checked != true){
